class profile::openstack::novacontroller {
  ...
  class { '::nova::keystone::auth':
	...
	ec2_public_url   => "http://${nova_public_ip}:8774/services/Cloud"
	ec2_internal_url => "http://${nova_admin_ip}:8774/services/Cloud"
	ec2_admin_url    => "http://${nova_admin_ip}:8774/services/Admin"
    region           => $region,
